    ...
    <>
      ...
      {!isOpen && (
        <Button
          ...
          size="icon"
          className="fixed bottom-8 left-8 z-[1001] h-14 w-14 rounded-full bg-gradient-primary shadow-lg hover:opacity-90 transition-opacity"
      ...
      {/* Chat window */}
      {isOpen && (
        <Card className="fixed bottom-8 left-8 z-[1001] w-96 shadow-xl">
